...
const pageApi = {
    optionBuyActivity: { url:"/wxapi/optionBuy.api", method:"get"},//频道商品
    rule: { url:"/wxapi/promotionRule.api" , method:"get" },//频道规则
    shop: { url: "/wxapi/optionBuyCart.api", method:"get" },//频道购物车
...
class OptionBuyActivity extends Component{
    ...
    dropDown =( me )=>{
        ...
        axios.request({ ...pageApi.optionBuyActivity,
            params:{
...
class OneItem extends Component{
    itemCtrl( id, itemData ){
        ...
        let redirect = encodeURIComponent(`/optionBuyActivity?promotion_id=${promotion_id}&shop_id=${shop_id}`);
