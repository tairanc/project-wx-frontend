...
const pageApi = {
    exchangeBuy: { url:"/wxapi/exchangeBuyItem.api", method:"get"},//频道商品
    rule: { url:"/wxapi/promotionRule.api" , method:"get" },//频道规则
    shop: { url: "/wxapi/exchangeBuyCart.api", method:"get" },//频道购物车
...
class OneItem extends Component{
    itemCtrl( id, itemData ){
        ...
        let redirect = encodeURIComponent(`/exchangeBuy?promotion_id=${promotion_id}&shop_id=${shop_id}`);
...
function exchangeBuyState ( state ) {
    return {
        ...state.minusActivity,
        ...state.global
    }
...
function exchangeBuyDispatch ( dispatch, props ) {
...
export default connect( exchangeBuyState, exchangeBuyDispatch )( ExchangeBuy );