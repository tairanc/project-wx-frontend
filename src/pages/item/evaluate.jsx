...
const createActions = concatPageAndType("evaluate");
const axiosCreator = actionAxios("evaluate");


const ctrlAPI = {
    listRate: {url: `${WXAPI}/rate/list`, method: "get"},   //评价列表
    likeRate: {url: `${WXAPI}/rate/like`, method: "post"} //点赞评价
};
...
class evaluate extends Component {
    ...
    componentDidMount() {
        let self = this;
        $(window).bind('scroll.eva', function () {
...
const stateEvaluate = function (state, props) {
    return {
        ...state.userCenter,
        ...state.global
    }
...
export default connect(stateEvaluate)(evaluate);