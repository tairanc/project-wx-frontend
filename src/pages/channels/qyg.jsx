...
const pageApi = {
	QYGBanner: {url: `${WXAPI}/getBanner`, method: "get"},
	QYGChannel: {url: `${WXAPI}/getChannel`, method: "get"},
	getCartCount: {url: `${WXAPI}/cart/count`, method: "get"},
};

//企业购
class QygList extends Component {
	constructor(props) {
		super(props);
	}
	...
	componentWillMount() {
		this.props.getDiscriminationByChannelType('qyg');
	}
...
//==============
export function qygState(state, props) {
	return {
		...state.channel,
		...state.global
	}
...
export function qygDispatch(dispatch, props) {
	return {
		getPageData: function () {
			axios.request({...pageApi.QYGBanner, params: {display_path: 30}})
				.then(result => {
...
export default connect(qygState, qygDispatch)(QygList);