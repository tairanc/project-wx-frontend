...
const ctrlAPI = {
    ...
    packageInfo: {url: `${WXAPI}/user/deliveryList`},//包裹信息
};
        ...
        return (
            ...
            <div className="eachPackage">
                <p className="packageTop clearfix">
                    ...
                    {express_no ? <input id='copy_text' className="express_no" value={express_no} readOnly/> :
                        <span className="express_no">等待上传</span>}
